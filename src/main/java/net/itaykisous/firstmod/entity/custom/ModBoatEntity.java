package net.itaykisous.firstmod.entity.custom;
...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case FIRST -> ModItems.FIRST_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.FIRST.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        FIRST(ModBlocks.FIRST_PLANKS.get(), "first");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, FIRST);
        }
    }
}
